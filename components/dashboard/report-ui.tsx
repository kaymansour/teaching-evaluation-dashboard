...
//
// The pieces both dashboards are built from: status pills, meters,
// section headings, chart panels, tables and the two shared plots.
//
// Keeping them here is what makes the overview and the faculty report
// read as one product rather than two that happen to sit on the same
// site.
